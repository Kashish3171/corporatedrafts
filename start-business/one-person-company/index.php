...
<html>
<head>
	<title>One Person Company Registration</title>
	  <meta charset="UTF-8">  
...
<meta name="keywords" content="One Person Company Registration, one person, one,person,company,registration,register,company,DIN,DSC,MOA,AOA,minimum requirments for company registering, roc, pan,tan,start business,new business, business,advantages for one person company, steps for  one person company, how to register company">
<meta name="description" content="One Person Company Registration">
</head>
</head>
<body>
 <div class="maskr">
...
<li><span class="glyphicon glyphicon-hand-right"></span> <a href="" class="dnav">One Person Company</a></li>
...
<!--CONTENT-LEVEL-2-->
<section class="e1" style='background-image: url("../../images/pl12-min.png");'>
<div class="e1div">
 <span class="e1span">
   Easily Register a OPC
 </span><br><br>
 <p>One Person company is the new concept launched in India. It is very popular in many Countries. We offer various types of one person company registration.</p><br>
 <span class="emibox">Starting From ₹10000/-</span><br><br><br>
 <span class="e1span1">Free Features</span>
 <ul>
 <li><span>1</span>PAN + TAN </li>
 <li><span>2</span>1 DIN + 1 DSC</li>
...
<section class="e2">
 ...
 <p>to Start One Person Company in India</p>
 <div class="e2div">
...
<section class="e3">
 ...
 <p>Why to Register One Person Company</p>
 <div class="e3div">
  <div class="e3div1">
  <div class="front">
...
<section class="e4">
 ...
 <p>for One Person Company Registration</p>
 <div class="e4div1">
 <div class="e4div2">
 <ul>
 <li><span>1</span>Minimum 1 Shareholders.</li>

 <li><span>2</span>Minimum 1 <strong>Directors</strong>.</li>
 </div>
 <div class="e4div2">
 <ul>
 ...
 <div class="e4div2">
 <ul>
 <li><span>5</span><strong>Minimum Authorised  Capital</strong> Rs. 100,000 (INR One Lac).</li>

 <li><span>6</span><strong>DIN </strong>(Director Identification Number) for all Directors.</li>
 </div>
 <div style="" class="e4div3 e4div2">
 <ul>
 <li><span>7</span><strong>DSC</strong> is  for Directors and 1 Promoter.</li>
</ul>
...
<section class="e6">
  <span class="e2span">
 FAQs</span><br>
 <p>On How to Register One Person Company in India</p>
 <div class="e6div">
 <ul>
