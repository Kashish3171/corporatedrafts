...
<html>
<head>
	<title>Public Limited Company Registration</title>
	  <meta charset="UTF-8">  
...
<!--CONTENT-LEVEL-2-->
<section class="e1" style='background-image: url("../../images/pl13-min.png");'>
<div class="e1div">
 <span class="e1span">
   Easily Register a Company
 </span><br><br>
 <p>Public limited company is the popular corporate entity amongst medium and large businesses in India due to various advantages. </p><br>
 <span class="emibox">Starting From ₹25000/-</span><br><br><br>
 <span class="e1span1">Free Features</span>
 <ul>
 <li><span>1</span>PAN + TAN </li>
 <li><span>2</span>3 DIN + 3 DSC</li>
...
<section class="e2">
 ...
 <p>to Start Public Limited Company in India</p>
 <div class="e2div">
...
<section class="e3">
 ...
 <p>Why to Register Public Limited Company</p>
 <div class="e3div">
  <div class="e3div1">
  <div class="front">
...
<section class="e4">
 ...
 <p>for Public Company Registration</p>
 <div class="e4div1">
 <div class="e4div2">
 <ul>
...
<section class="e6">
  <span class="e2span">
 FAQs</span><br>
 <p>On How to Register Public Limited Company in India</p>
 <div class="e6div">
 <ul>
...
<div class="regheader">
 ...
 <form action="" method="POST" class="regf">
   ...
   <div class="form-group">
     ...
     <input type="text" name="regtype" class="form-control" value="Public Limited Company Registration" readonly="true">
     </div>
