...
<!--CONTENT-LEVEL-2-->
<section class="e1" style='background-image: url("../../images/pl15-min.png");'>
<div class="e1div">
 <span class="e1span">
  Easily Register a Partnership
 </span><br><br>
 <p>Partnership could be registered or unregistered. Partnerships are ideal for small business in the unorganised sector having multiple promoters. </p><br>
 <span class="emibox">Starting From ₹6000/-</span><br><br><br>
...
<section class="e2">
 ...
 <p>to Start Partnership in India</p>
 <div class="e2div">
...
<section class="e4">
 ...
 <p>for Partnership Registration</p>
 <div class="e4div1">
 <div class="e4div2">
 <ul>
...
<div class="regheader">
 ...
 <form action="" method="POST" class="regf">
   ...
   <div class="form-group">
     ...
     <input type="text" name="regtype" class="form-control" value="Partnership Registration" readonly="true">
     </div>
